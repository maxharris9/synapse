/* tritri.c -
 * Triangle intersection test routine for System 1.0
 * Copyright(c) 1997 Tomas Moller.
 * Portions Copyright(c) 1998 Objective Reality Computer.
 */
...
int
  coplanar_tri_tri(float N[3], float V0[3], float V1[3], float V2[3],
...
int
  tri_tri_intersect(float V0[3], float V1[3], float V2[3],
		    float U0[3], float U1[3], float U2[3])
{
   float E1[3], E2[3];
